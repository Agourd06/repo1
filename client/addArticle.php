...
<head>
 ...
 $(document).ready(function () {
    ...
    $("#simple-search").on("input", function () {
        ...
        var themeId = getThemeIdFromURL(); // Replace this with your actual function to get theme_id

        // Make an AJAX request to the search script
        $.ajax({
            type: "GET",
            url: "search.php", // Path to your search script
            data: { query: searchQuery, theme_id: themeId }, // Include theme_id in data
    ...
    // Function to extract theme_id from URL
    function getThemeIdFromURL() {
        // You may need to modify this based on your URL structure
        var urlParams = new URLSearchParams(window.location.search);
        var themeId = urlParams.get('theme_id');
        return themeId;
    }
});
...
<body >
    <nav class="relative px-4 py-4 flex justify-between items-center bg-gray-100 w-full overflow-x-hidden m-0">
        ...
        <div class="flex gap-[10px]">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" fill="red" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.--><path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z"/></svg>
            </a>
        </div>
