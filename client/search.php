...
$themeId = isset($_GET['theme_id']) ? $_GET['theme_id'] : '';
// Perform a search query (modify as needed)
$searchResultsQuery = "SELECT a.article_title, a.content, a.article_image, DATE_FORMAT(a.created_at, '%Y-%m-%d') as created_at, u.fullname
FROM article a
INNER JOIN users u ON a.author_id = u.user_id
WHERE  a.article_title LIKE '%$searchQuery%'
